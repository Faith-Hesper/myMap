...
(function() {
    ...
    function load() {
        ...
        if (!inArray(includes, 'ol-debug') && !inArray(includes, 'ol@4.6.5') && !inArray(excludes, 'ol')) {
            inputCSS('../../web/libs/openlayers/6.4.3/ol.css');
            inputScript('../../web/libs/openlayers/6.4.3/ol.js');
        }
        ...
        if (inArray(includes, 'ol3-echarts')) {
            inputScript('../../web/libs/openlayers/ol3-echarts/2.0.3/ol3Echarts.min.js');
        }
        ...
        if (inArray(includes, 'ol-mapbox-style')) {
            inputScript('../../web/libs/openlayers/plugins/ol-mapbox-style/2.11.2-2/olms.js');
        }
        ...
        if (inArray(includes, 'layerswitcher')) {
            inputCSS('../../web/libs/openlayers/plugins/ol-layerswitcher/3.6.0/ol-layerswitcher.css');
            inputScript('../../web/libs/openlayers/plugins/ol-layerswitcher/3.6.0/ol-layerswitcher.js');
        }
