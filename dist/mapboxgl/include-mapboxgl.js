...
(function () {
    ...
    function load() {
        ...
        if (!inArray(includes, 'mapbox-gl-enhance') && !inArray(excludes, 'mapbox-gl')) {
            inputCSS('../../web/libs/mapbox-gl-js/1.6.1/mapbox-gl.css');
            inputScript('../../web/libs/mapbox-gl-js/1.6.1/mapbox-gl.js');
        }
        ...
        if (inArray(includes, 'compare')) {
            inputCSS('../../web/libs/mapbox-gl-js/plugins/mapbox-gl-compare/0.3.0/mapbox-gl-compare.css');
            inputScript('../../web/libs/mapbox-gl-js/plugins/mapbox-gl-compare/0.3.0/mapbox-gl-compare.js');
        }
        if (inArray(includes, 'mapv')) {
            inputScript('../../web/libs/mapv/2.0.56/mapv.min.js');
        }
        ...
        if (inArray(includes, 'antd')) {
            ...
            inputScript("../../web/libs/moment/2.24.0/moment.min.js");
        ...
        if (inArray(includes, 'OBJLoader')) {
            inputScript("../../web/libs/three/0.121.1/examples/js/loaders/OBJLoader.js");
        }
        if (inArray(includes, 'MTLLoader')) {
            inputScript("../../web/libs/three/0.121.1/examples/js/loaders/MTLLoader.js");
        }
        if (inArray(includes, 'GLTFLoader')) {
            inputScript("../../web/libs/three/0.121.1/examples/js/loaders/GLTFLoader.js");
        }
        if (inArray(includes, 'proj4')) {
            inputScript('../../web/libs/proj4/2.6.2/proj4.js');
        }
        ...
        if (inArray(includes, 'canvg')) {
            inputScript('../../web/libs/canvg/3.0.6/canvg.min.js');
        }
        ...
        if (inArray(includes, 'xlsx')) {
            inputScript('../../web/libs/xlsx/0.16.7/xlsx.core.min.js');
        }
