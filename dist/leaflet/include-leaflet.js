...
(function () {
    ...
    function load() {
        ...
        if (inArray(includes, 'iclient-plot-leaflet')) {
            inputCSS("libs/plotting/leaflet/10.1.1/iclient-plot-leaflet.css");
            if (supportES6()) {
                inputScript("libs/plotting/leaflet/10.1.1/iclient-plot-leaflet-es6.min.js");
            } else {
                inputScript("libs/plotting/leaflet/10.1.1/iclient-plot-leaflet.min.js");
            }
        }
        ...
        if (inArray(includes, 'leaflet-mapbox-gl')) {
            inputScript('libs/leaflet-mapbox-gl/0.0.14/leaflet-mapbox-gl.js');
        }
    }
