(function () {
    ...
    function load() {
        ...
        if (!inArray(excludes, "default")) {
            inputScript("../examples/dist/leaflet/config.js");
        ...
        if (inArray(includes, 'leaflet')) {
            inputCSS("libs/dist/leaflet/leaflet.css");
            inputScript("libs/dist/leaflet/leaflet.js");
        }
        if (inArray(includes, 'leaflet-1.0.3')) {
            inputCSS("libs/dist/leaflet/1.0.3/leaflet.css");
            inputScript("libs/dist/leaflet/1.0.3/leaflet.js");
        }
        if (inArray(includes, 'leaflet-1.3.1')) {
            inputCSS("libs/dist/leaflet/1.3.1/leaflet.css");
            inputScript("libs/dist/leaflet/1.3.1/leaflet.js");
        }
        if (inArray(includes, 'iclient-leaflet')) {
            if (supportES6()) {
                inputScript("../dist/dist/leaflet/iclient-leaflet-es6.min.js");
            } else {
                inputScript("../dist/dist/leaflet/iclient-leaflet.min.js");
            }
        }
        // iClient classsic
